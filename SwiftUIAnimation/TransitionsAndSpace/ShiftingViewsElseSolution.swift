//
//  ShiftingViewsElseSolution.swift
//  SwiftUIAnimation
//
...
struct ShiftingViewsElseSolution: View {
...
struct ShiftingViewsElseSolution_Previews: PreviewProvider {
    static var previews: some View {
        ShiftingViewsElseSolution()
    }
}
